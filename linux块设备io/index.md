...
&emsp;&emsp;在我的一篇博客 [操作系统概述](https://taofengliu.github.io/操作系统概述/) 中我画了一张关于Linux的块设备I/O分层的示意图，就是下面这张图。这里再写两篇博客整理一下这张图涉及到的知识点，尽量避免陷入源码细节，做到先有宏观认知，再了解各个分层的功能与简单原理即可。
![Linux块IO分层](/posts/Linux块设备IO-总览/块io分层.jpg "Linux块IO分层")

&emsp;&emsp;作为第一篇博客，首先会大致说明Linux中块设备I/O的一般体系结构，有一个宏观的认知，之后的博客会对VFS重点的内容进行详细整理。
